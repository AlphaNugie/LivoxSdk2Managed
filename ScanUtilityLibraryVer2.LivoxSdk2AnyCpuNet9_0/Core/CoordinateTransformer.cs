...
namespace ScanUtilityLibraryVer2.LivoxSdk2.Core
{
    ...
    {
        /// <summary>
        /// 将点云坐标系中的多个笛卡尔坐标系高精度点批量变换到现实空间坐标系，并更新点云坐标
        /// </summary>
        ...
        /// <summary>
        /// 将点云坐标系中的笛卡尔坐标系高精度点变换到现实空间坐标系，并更新点云坐标
        /// </summary>
        /// <param name="highRawPoint">笛卡尔坐标系高精度点对象</param>
        /// <param name="paramSet">坐标转换参数集</param>
        ...
        /// </summary>
        /// <param name="lowRawPoint">笛卡尔坐标系低精度点对象</param>
        /// <param name="paramSet">坐标转换参数集</param>
        /// <exception cref="ArgumentNullException"></exception>
        public static void TransformPoint(/*this */ref LivoxLidarCartesianLowRawPoint lowRawPoint, CoordTransParamSet paramSet)
        {
            if (paramSet == null)
                throw new ArgumentNullException(nameof(paramSet), "空间旋转位移参数不能为空");
            var coord = TransformPoint(lowRawPoint.x, lowRawPoint.y, lowRawPoint.z, paramSet);
            lowRawPoint.x = (short)coord[0];
            lowRawPoint.y = (short)coord[1];
            lowRawPoint.z = (short)coord[2];
        }
